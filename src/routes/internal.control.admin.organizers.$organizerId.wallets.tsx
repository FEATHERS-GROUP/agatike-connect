        ...
        {workspaces.map((ws: any) => {
          ...
          if (!wallet) {
            return (
              <div
                key={ws.id}
                className="bg-gray-100 dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333333] p-5 flex items-center justify-between"
              >
                <div>
                  ...
                  <p className="text-gray-600 dark:text-[#797775] text-xs mt-1">
            ...
            <div key={ws.id} className="bg-gray-100 dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333333] overflow-hidden">
              <div className="p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 dark:border-[#333333] bg-gray-50 dark:bg-[#252526]">
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-2 text-gray-600 dark:text-[#797775] text-xs">
                  ...
                  <div className="space-y-4">
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 text-xs rounded-sm border flex flex-col items-start gap-1 transition-colors ${
                              active
                                ...
                                : "bg-white dark:bg-[#111] border-gray-200 dark:border-[#333] text-gray-600 dark:text-[#797775] hover:border-gray-300 dark:hover:border-gray-300 dark:border-[#555] hover:text-gray-900 dark:hover:text-white"
                            }`}
                          >
                            <div className="flex items-center gap-1.5 w-full">
                              <div
                                className={`h-3 w-3 shrink-0 rounded-full border ${active ? "bg-[#84c87e] border-[#84c87e]" : "border-gray-300 dark:border-[#555]"}`}
                              />
                    ...
                    <div className="flex items-center gap-2 pt-2">
                      <button
                        ...
                        className="px-3 py-1.5 text-xs border border-gray-200 dark:border-[#333333] text-gray-600 dark:text-[#797775] hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-1 rounded-sm"
                      >
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="px-3 py-1.5 text-xs bg-[#569cd6] text-gray-900 dark:text-white hover:bg-[#4a8cc0] transition-colors flex items-center gap-1 rounded-sm disabled:opacity-50"
                      >
                        {loading ? (
                    ...
                    {currentNetworks.length === 0 ? (
                      ...
                      currentNetworks.map((n: string) => {
                        ...
                        return (
                          <span
                            key={n}
                            className="px-2.5 py-1 text-[11px] bg-gray-200 dark:bg-[#333333] text-gray-700 dark:text-[#cccccc] rounded-sm capitalize border border-gray-300 dark:border-[#444444]"
                          >
