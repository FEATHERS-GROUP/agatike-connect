            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-border/60">
                {chartData.map((tier: any) => {
                  ...
                  const locationName =
                    tier.tour_stop_idx != null && event.tour_stops?.[tier.tour_stop_idx]
                      ? event.tour_stops[tier.tour_stop_idx].city ||
                        event.tour_stops[tier.tour_stop_idx].venue ||
                        `Stop ${tier.tour_stop_idx + 1}`
                      : "All Locations";
                  ...
                  return (
                    <tr key={tier.id} className="hover:bg-secondary/20 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-medium ${isSoldOut ? "bg-red-500/10 text-red-500" : "bg-green-500/10 text-green-500"}`}
                        >
