...
function AdminPricingDetailsPage() {
  ...
  const handleOpenEdit = () => {
    ...
    if (typeof modulesArr === "string") {
      try {
        modulesArr = JSON.parse(modulesArr);
      } catch {
        modulesArr = [];
      }
    }
    ...
    if (typeof usageLimits === "string") {
      try {
        usageLimits = JSON.parse(usageLimits);
      } catch {
        usageLimits = {};
      }
    }
    ...
    return (
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="text-center py-12">
          ...
          <Link
            to="/internal/control/admin/pricing"
      ...
      <div className="bg-gray-50 dark:bg-[#1b1b1c] border border-gray-200 dark:border-[#333333] rounded-xl w-full max-w-4xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
              ...
              return (
                <div key={title} className="flex flex-col items-center flex-1">
                  <div className="flex items-center w-full">
                    <div
                      className={`h-0.5 flex-1 transition-colors ${idx === 0 ? "invisible" : isCompleted || isActive ? "bg-[#f97316]" : "bg-gray-200 dark:bg-[#333333]"}`}
                    />
                    <button
                      type="button"
                    ...
                    <div
                      className={`h-0.5 flex-1 transition-colors ${idx === TOTAL_STEPS - 1 ? "invisible" : isCompleted ? "bg-[#f97316]" : "bg-gray-200 dark:bg-[#333333]"}`}
                    />
                  </div>
                  <span
                    className={`text-[10px] mt-2 text-center leading-tight ${isActive ? "text-gray-900 dark:text-white font-medium" : isCompleted ? "text-[#f97316]/80" : "text-muted-foreground"}`}
                  >
                    {title}
                  </span>
                </div>
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    value={formState.billing_cycle || "monthly"}
                ...
                <div className="space-y-1.5 col-span-2">
                  ...
                  />
                  <p className="text-[10px] text-muted-foreground">
                    A short marketing description shown on the pricing page.
                  </p>
                </div>
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    If inactive, users cannot select this plan.
                  </p>
                </div>
                <div className="space-y-1.5">
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-[#333333] pb-2">
              ...
              <div className="space-y-4 bg-blue-500/5 p-4 rounded-xl border border-blue-500/20">
                <h3 className="text-sm font-semibold text-blue-400 border-b border-blue-500/20 pb-2">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    />
                    <p className="text-[10px] text-blue-400/60">
                      Percentage passed directly to the end customer when buying tickets.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4 p-4 bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-[#333333]">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 dark:bg-[#1b1b1c] border border-gray-200 dark:border-[#333333] rounded px-2 py-1.5 text-xs text-gray-900 dark:text-white"
                      />
                      <p className="text-[9px] text-muted-foreground leading-tight">
                        Overrides the Customer Service Fee if set.
                      </p>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-medium text-muted-foreground">
                  ...
                  <div className="space-y-1.5 pt-2 border-t border-gray-200 dark:border-[#333333]">
                    ...
                    <p className="text-[9px] text-muted-foreground">
                      If Yes, the Organizer absorbs the customer fee up to a limit.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4 p-4 bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-[#333333]">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      />
                      <p className="text-[9px] text-muted-foreground leading-tight">
                        Overrides the Organizer Platform Contribution for withdrawals.
                      </p>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-medium text-muted-foreground">
                        Withdraw Override (Fixed)
                      </label>
                      <input
                        type="number"
                        step="1"
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-gray-200 dark:border-[#333333] pb-2">
                  ...
                  <button
                    onClick={addFeature}
                    className="text-xs flex items-center gap-1 text-[#f97316] hover:text-[#ea580c] transition-colors"
                  >
                    <Plus className="h-3 w-3" /> Add Feature
                  </button>
                </div>
                <p className="text-[10px] text-muted-foreground">
                  These are bullet points displayed to customers.
                </p>
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] text-muted-foreground">
                  Select the system modules granted by this subscription.
                </p>
                <div className="grid grid-cols-1 gap-2 max-h-60 overflow-y-auto custom-scrollbar pr-2">
                  {platformModules.map((module: any) => {
                    ...
                    return (
                      <label
                        key={module.id}
                        className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${isIncluded ? "bg-blue-500/10 border-blue-500/30" : "bg-white dark:bg-[#111111] border-gray-200 dark:border-[#333333] hover:border-gray-300 dark:hover:border-[#444444]"}`}
                      >
                        <input
                          type="checkbox"
                          checked={isIncluded}
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#333333] rounded-xl space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Toggle features that are unlocked for organizers on this plan. Disabled
                        features show an upgrade prompt.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 dark:bg-[#1b1b1c] border border-gray-200 dark:border-[#333333] rounded-xl p-4 space-y-2">
                      <div>
                        ...
                        <div className="text-[11px] text-muted-foreground mt-0.5">
                          Controls which venue design editor features are available in Agatike
                          Studio for this plan.
                        </div>
                      </div>
                      <select
                      ...
                      >
                        <option value="basic">
                          Basic — Standard templates, limited customization
                        </option>
                        <option value="advanced">Advanced — Full editor, custom branding</option>
                        <option value="custom">
                          Custom — White-label, API access, full control
                        </option>
                      </select>
                    </div>
                  </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-[#333333] bg-white dark:bg-[#111111] flex justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => setIsEditModalOpen(false)}
              className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-gray-900 dark:hover:text-white transition-colors"
            >
              Cancel
            </button>
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link
          to="/internal/control/admin/pricing"
          className="p-2 hover:bg-gray-200 dark:hover:bg-[#333333] rounded-lg transition-colors text-muted-foreground hover:text-gray-900 dark:hover:text-white"
        >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            {!plan.active && (
              <span className="bg-red-500/10 text-red-400 px-2 py-0.5 rounded text-xs uppercase font-bold border border-red-500/20">
                Inactive
              </span>
            )}
            {plan.is_popular && (
              <span className="bg-blue-500/10 text-blue-400 px-2 py-0.5 rounded text-xs uppercase font-bold border border-blue-500/20">
                Popular
              </span>
            )}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <div className="text-xl font-bold text-purple-400">
                  {plan.customer_service_fee_percentage || 0}%
                </div>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {!plan.modules_included || plan.modules_included.length === 0 ? (
                    ...
                    ).map((mId: string, i: number) => {
                      const mod = platformModules.find((p: any) => p.id === mId);
                      return (
                        <li
                          key={i}
                          className="text-sm text-blue-400 flex items-start gap-2 bg-blue-500/10 px-3 py-2 rounded-lg border border-blue-500/20"
                        >
          ...
          {(() => {
            const ul =
              typeof plan.usage_limits === "string"
                ? (() => {
                    try {
                      return JSON.parse(plan.usage_limits);
                    } catch {
                      return {};
                    }
                  })()
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
                      {limitKeys.map(({ key, label }) => {
                        ...
                        return (
                          <div
                            key={key}
                            className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#333333] rounded-lg p-3 text-center"
                          >
                            <div className="text-xl font-bold text-gray-900 dark:text-white">
                              {display}
                            </div>
                            <div className="text-[10px] text-muted-foreground mt-1 uppercase tracking-wide leading-tight">
                              {label}
                            </div>
                          </div>
                        );
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={key}
                          className={`px-3 py-1.5 rounded-lg text-xs font-semibold border ${ul[key] ? "bg-green-500/10 text-green-400 border-green-500/20" : "bg-white dark:bg-[#111111] text-muted-foreground border-gray-200 dark:border-[#333333]"}`}
                        >
                          {ul[key] ? "✓" : "✗"} {label}
                        </span>
                      ))}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
                    {formatCurrency(stats?.monthlyRecurringRevenue || 0, plan.currency || "USD")}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto custom-scrollbar pr-2">
                {stats?.subscriptions?.length === 0 ? (
                  ...
                  stats?.subscriptions?.map((sub: any) => (
                    <div
                      key={sub.id}
                      className="flex justify-between items-center p-2 rounded-lg bg-gray-50 dark:bg-[#1b1b1c] border border-gray-200 dark:border-[#333333]"
                    >
                      <div className="text-sm text-gray-900 dark:text-white truncate max-w-[150px]">
                        {sub.workspace?.name || sub.organizer?.name || "Unknown Workspace"}
                      </div>
                      <span
                        className={`text-[10px] px-1.5 py-0.5 rounded uppercase font-bold ${sub.status === "active" || sub.status === "ACTIVE" ? "bg-green-500/10 text-green-400" : "bg-red-500/10 text-red-400"}`}
                      >
                        {sub.status}
                      </span>
                    </div>
