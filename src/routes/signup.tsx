          ...
          <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-black p-12 text-white lg:flex xl:w-5/12">
            ...
            <div className="relative z-10 mt-auto">
              ...
              <p className="mt-6 max-w-sm text-sm font-medium leading-relaxed text-white/70">
                Create an account to save events, follow your favorite organizers, and unlock
                exclusive VIP drops.
              </p>
            </div>
          </div>
                ...
                {otpStep ? (
                  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="signup-otp" className="text-sm font-medium text-slate-700">
                        Verification Code
                      </Label>
                      <Input
                        id="signup-otp"
                  ...
                  <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-500">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="signup-pw" className="text-sm font-medium text-slate-700">
                        Password
                      </Label>
                      <div className="relative">
                        <Input
                    ...
                    <div className="flex items-start gap-2 pt-1">
                      ...
                      <label
                        htmlFor="terms"
                        className="text-xs leading-snug text-slate-500 cursor-pointer"
                      >
                        I agree to the{" "}
                        <Link
                          to="/terms"
