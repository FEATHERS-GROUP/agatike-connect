          ...
          <table className="w-full text-left text-[13px] whitespace-nowrap">
            <thead className="bg-[#2d2d30] text-[#cccccc]">
              <tr>
                ...
                <th className="font-semibold py-2 px-4 border-b border-[#333333]">Records</th>
                <th className="font-semibold py-2 px-4 border-b border-[#333333]">Fields</th>
                    ...
                    <tr key={b.id} className="hover:bg-[#2d2d30] transition-colors">
                      ...
                      <td className="py-2 px-4">
                        <div className="flex items-center gap-1.5 text-[#cccccc]">
                          <List className="h-3.5 w-3.5 text-[#797775]" />
                          {b.recordCount}
                        </div>
                      </td>
