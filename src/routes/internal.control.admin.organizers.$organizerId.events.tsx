...
function StatusBadge({
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm bg-gray-200 dark:bg-[#797775]/10 text-gray-600 dark:text-[#797775] text-xs font-medium">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-2 border-b border-gray-200 dark:border-[#333333] gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full sm:w-64 bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#333333] rounded-sm py-1.5 pl-9 pr-3 text-sm text-gray-900 dark:text-white placeholder-[#797775] focus:outline-none focus:border-[#f97316] transition-colors"
          />
        </div>
      </div>
                ...
                filtered.map((evt: any) => {
                  ...
                  return (
                    <tr key={evt.id} className="hover:bg-gray-200 dark:hover:bg-[#2d2d30] transition-colors">
                      ...
                      <td className="py-2 px-4 font-medium text-gray-900 dark:text-white max-w-[200px]">
                      ...
                      <td className="py-2 px-4 capitalize">
                        {evt.category ? (
                          <span className="bg-gray-100 dark:bg-[#2d2d30] px-2 py-0.5 rounded-full text-xs text-gray-700 dark:text-[#cccccc]">
                            {evt.category}
                          </span>
                        ) : (
