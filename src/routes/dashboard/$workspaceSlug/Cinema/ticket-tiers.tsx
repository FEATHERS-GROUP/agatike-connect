    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-6xl mx-auto">
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 flex items-start gap-3">
        ...
        <p className="text-sm text-foreground/80">
          Ticket tiers are <strong>global templates</strong>. Once created here, they can be attached
          to any movie, show, or cinema in your workspace — including different prices per cinema.
        </p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border/60 bg-secondary/40">
              <th className="text-left px-6 py-4 font-semibold text-muted-foreground">Tier Name</th>
              <th className="text-left px-4 py-4 font-semibold text-muted-foreground hidden md:table-cell">Type</th>
              <th className="text-left px-4 py-4 font-semibold text-muted-foreground">Features</th>
              <th className="text-right px-4 py-4 font-semibold text-muted-foreground">Base Price</th>
      ...
      <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
        <SheetContent className="w-full sm:max-w-lg overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Type & Price */}
            <div className="space-y-4">
              <h4 className="font-semibold text-sm text-muted-foreground uppercase tracking-wider">Pricing</h4>
            ...
            {/* Feature Toggles */}
            <div className="space-y-4">
              <h4 className="font-semibold text-sm text-muted-foreground uppercase tracking-wider">Features & Tags</h4>
              <div className="grid grid-cols-1 gap-3">
                {[
                  { key: "is_3d", icon: <Box className="h-4 w-4" />, label: "3D Screening", desc: "Movie is shown in 3D format" },
                  { key: "includes_glasses", icon: <Glasses className="h-4 w-4" />, label: "Glasses Included", desc: "3D glasses are provided with this ticket" },
                  { key: "is_imax", icon: <Layers className="h-4 w-4" />, label: "IMAX Format", desc: "Shown on an IMAX screen" },
                  { key: "is_vip", icon: <Star className="h-4 w-4" />, label: "VIP Tier", desc: "Premium seating or perks included" },
                  { key: "is_kids", icon: <Baby className="h-4 w-4" />, label: "Kids Ticket", desc: "Discounted ticket for children" },
                  ...
                  >
                    <div className={`p-2 rounded-lg ${form[key] ? "bg-primary/20" : "bg-secondary"}`}>
                      {icon}
                    </div>
