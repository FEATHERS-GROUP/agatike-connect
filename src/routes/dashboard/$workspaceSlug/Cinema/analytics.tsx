...
const TOP_MOVIES = [
  { title: "Oppenheimer", cinema: "Century Cinema", tickets: 1820, revenue: 18_200_000, currency: "RWF" },
  { title: "Barbie", cinema: "Canal Olympia", tickets: 1240, revenue: 12_400_000, currency: "RWF" },
  { title: "Top Gun: Maverick", cinema: "Century Cinema", tickets: 980, revenue: 9_800_000, currency: "RWF" },
  { title: "The Batman", cinema: "Century Cinema", tickets: 860, revenue: 8_600_000, currency: "RWF" },
  { title: "Black Panther", cinema: "Canal Olympia", tickets: 720, revenue: 7_200_000, currency: "RWF" },
];
    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-6xl mx-auto">
      ...
      <div className="bg-card border border-border/60 rounded-3xl p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {CINEMA_STATS.map((cinema) => (
            <div key={cinema.id} className="flex items-center gap-4 p-4 bg-secondary/30 rounded-2xl border border-border/40">
              <div className="relative h-16 w-16 shrink-0">
                <svg className="h-16 w-16 -rotate-90" viewBox="0 0 36 36">
                  <circle cx="18" cy="18" r="14" fill="none" stroke="currentColor"
                    strokeWidth="4" className="text-secondary" />
