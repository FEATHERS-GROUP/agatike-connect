    ...
    <div className="space-y-6 max-w-4xl mx-auto w-full">
      <header className="flex flex-col gap-2">
        <Button
          ...
          onClick={() => navigate({ to: `/dashboard/${activeWorkspace?.slug}/products&add-ons` })}
        >
      ...
      <div className="bg-card rounded-2xl border border-border/60 p-6 sm:p-8 shadow-[var(--shadow-card)]">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-6 flex justify-end gap-3 border-t">
            <Button variant="ghost" type="button" onClick={() => navigate({ to: `/dashboard/${activeWorkspace?.slug}/products&add-ons` })}>
              Cancel
            </Button>
            <Button
              type="submit"
