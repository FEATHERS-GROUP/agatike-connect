        ...
        <div className="flex-1 overflow-x-auto bg-slate-100 p-8 rounded-3xl shadow-inner min-h-[800px] flex items-start justify-center print:bg-white print:p-0 print:shadow-none print:rounded-none">
          ...
          >
            ...
            <div className="mb-8 flex-1 relative z-10">
              <div
                className={cn(
                  "grid grid-cols-[1fr_80px_120px_120px_40px] gap-4 pb-2 mb-4",
                  theme.tableHeaderBg,
              ...
              <div className="space-y-2">
                {items.map((item, idx) => (
                  <div
                    key={idx}
                    className={cn(
                      "grid grid-cols-[1fr_80px_120px_120px_40px] gap-4 items-center group",
                      isPO ? "border-b border-slate-100 pb-2" : "",
                    )}
                  >
                    <input
              ...
              <div className="mt-4 print:hidden">
                <Button
                  ...
                  size="sm"
                  className={cn(
                    "rounded-xl gap-1.5 border-dashed border-2 hover:bg-transparent",
                    isPO
              ...
              >
                ...
                <div className="flex justify-between text-sm text-slate-600">
                  <span className="flex items-center gap-2">
                    ...
                    <input
                      type="number"
                      className="w-16 h-6 text-xs px-1 border rounded text-center bg-white/50 focus:bg-white"
                      value={taxRate}
                      onChange={(e) => setTaxRate(Number(e.target.value))}
                    />
                    %
