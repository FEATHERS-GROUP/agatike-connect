              ...
              {formData.type === "physical" && (
                <div className="rounded-3xl border border-border/40 bg-card p-8 shadow-[var(--shadow-card)] space-y-10">
                          ...
                          <div className="p-5 space-y-4">
                                ...
                                {size.colors.map((color) => (
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-4">
                                      <span className="text-muted-foreground text-xs uppercase tracking-widest font-semibold">
                                        Stock:{" "}
                                        <span className="text-foreground">{color.stock}</span>
                                      </span>
                                      <button
                                        type="button"
                            ...
                            <div className="flex gap-3 items-center bg-background p-1.5 rounded-2xl border border-border/20">
                              <Input
                                ...
                                onChange={(e) =>
                                  updateColorInput(size.name, "name", e.target.value)
                                }
                                onKeyDown={(e) =>
                                  e.key === "Enter" &&
                                  (e.preventDefault(), addColorToSize(size.name))
                                }
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  updateColorInput(size.name, "stock", e.target.value)
                                }
                                onKeyDown={(e) =>
                                  e.key === "Enter" &&
                                  (e.preventDefault(), addColorToSize(size.name))
                  ...
                  <div className="space-y-4 pt-4 border-t border-border/20">
                    ...
                    >
                      <PlusCircle className="h-5 w-5 mr-2 text-muted-foreground" /> Add
                      Specification
                    </Button>
                  </div>
                </div>
