...
import { ArrowLeft, UserPlus, Users, Loader2, Search, X, Check, Lock, Shield, ArrowRight, ScanLine, Ticket, BarChart3, MapPin, CheckCircle2 } from "lucide-react";
...
function AddStaffPage() {
  ...
  const [accountInputs, setAccountInputs] = useState([{ handle: "", user: null as any, first_name: "", last_name: "", phone: "", id_passport: "", error: "", isLoading: false }]);
  const [noAccountInputs, setNoAccountInputs] = useState([{ first_name: "", last_name: "", email: "", phone: "", id_passport: "" }]);
        ...
        {step === 2 && registrationType === "account" && (
          <div className="space-y-6">
            ...
            <Button 
              ...
              onClick={() => setAccountInputs([...accountInputs, { handle: "", user: null, first_name: "", last_name: "", phone: "", id_passport: "", error: "", isLoading: false }])}
            >
        ...
        {step === 2 && registrationType === "no-account" && (
          <div className="space-y-6">
            ...
            <Button 
              variant="outline" 
              className="w-full border-dashed"
              onClick={() => setNoAccountInputs([...noAccountInputs, { first_name: "", last_name: "", email: "", phone: "", id_passport: "" }])}
            >
