      ...
      <div className="relative z-10 w-full max-w-md mx-auto rounded-[2.5rem] border border-white/10 bg-black/40 backdrop-blur-2xl p-8 sm:p-12 shadow-2xl overflow-hidden">
        <div className="text-center mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="inline-flex h-20 items-center justify-center mb-4">
            <img src="/icon.svg" alt="Agatike Icon" className="h-20 w-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]" />
          </div>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm font-medium text-primary hover:text-primary/80 transition-colors drop-shadow-[0_0_5px_rgba(242,87,29,0.3)]">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
          ...
          <p className="mt-8 text-center text-sm text-white/60">
            ...
            <Link to="/dashboard/create-organizer" className="font-semibold text-primary hover:text-primary/80 transition-colors drop-shadow-[0_0_5px_rgba(242,87,29,0.3)]">
              Create Profile
            </Link>
          </p>
        </div>
