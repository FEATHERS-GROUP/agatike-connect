                      ...
                      <td className="py-2 px-4">
                        {b.accent_color ? (
                          <span className="flex items-center gap-1.5">
                            <span
                              className="inline-block h-3 w-3 rounded-full border border-[#444]"
                              style={{ backgroundColor: b.accent_color }}
                            />
                            <span className="text-xs font-mono text-[#797775]">
                              {b.accent_color}
                            </span>
                          </span>
                        ) : (
                    ...
                    <tr key={p.id} className="hover:bg-[#2d2d30] transition-colors">
                      ...
                      <td className="py-2 px-4">
                        {p.is_published ? (
                          ...
                          <span className="inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-sm bg-[#797775]/10 text-[#797775]">
