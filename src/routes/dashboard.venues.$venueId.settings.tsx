    ...
    <div className="max-w-4xl space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-card p-6 rounded-3xl border border-border/60">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">Update your property's public listing information.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-card p-6 rounded-3xl border border-border/60 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">List the amenities included in the rental price.</p>
            <Input defaultValue={venue.amenities.join(", ")} className="h-10 rounded-xl bg-secondary/50" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-card p-6 rounded-3xl border border-border/60 space-y-4">
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 p-3 border border-border/60 rounded-xl cursor-pointer hover:bg-secondary/20 transition-colors">
                <input type="radio" name="status" defaultChecked={venue.status === "Active"} className="accent-primary" />
                <div>
              ...
              <label className="flex items-center gap-3 p-3 border border-border/60 rounded-xl cursor-pointer hover:bg-secondary/20 transition-colors">
                <input type="radio" name="status" defaultChecked={venue.status === "Draft"} className="accent-primary" />
                <div>
              ...
              <label className="flex items-center gap-3 p-3 border border-border/60 rounded-xl cursor-pointer hover:bg-secondary/20 transition-colors">
                <input type="radio" name="status" defaultChecked={venue.status === "Maintenance"} className="accent-primary" />
                <div>
          ...
          <div className="bg-card p-6 rounded-3xl border border-border/60 space-y-4">
            ...
            <Button variant="outline" className="w-full rounded-xl">Upload New Photo</Button>
          </div>
        </div>
      </div>
    </div>
