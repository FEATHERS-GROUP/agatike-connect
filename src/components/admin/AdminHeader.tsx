    ...
    <header className="flex h-12 w-full shrink-0 items-center justify-between bg-gray-50 dark:bg-[#1b1b1c] px-3 font-sans text-sm border-b border-gray-200 dark:border-[#333333]">
      ...
      <div className="flex items-center flex-1 max-w-lg mx-6 relative">
        ...
        <input
          ...
          className="h-8 w-full rounded-sm border border-gray-200 dark:border-[#333333] bg-white dark:bg-[#111111] pl-9 pr-3 text-xs text-gray-900 dark:text-white outline-none focus:border-[#f97316] focus:ring-1 focus:ring-[#f97316] transition-colors placeholder:text-gray-600 dark:text-[#797775]"
        />
      </div>
