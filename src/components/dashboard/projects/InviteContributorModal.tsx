...
export function InviteContributorModal({
  ...
  const { data: contributors = [], isLoading } = useQuery({
    ...
    queryFn: () =>
      getContributors({ data: { resource_type: resourceType, resource_id: resourceId } } as any),
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-end gap-3 p-1">
              <div className="flex-1 w-full space-y-1.5">
                <Label className="text-xs text-muted-foreground uppercase tracking-wide font-medium ml-1">
                  Email Address
                </Label>
              ...
              <div className="w-full sm:w-[140px] space-y-1.5">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="view" className="bg-background">
                      View only
                    </option>
                    <option value="edit" className="bg-background">
                      Can edit
                    </option>
                  </select>
              ...
              <Button
                ...
                disabled={
                  !email || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email) || inviteMutation.isPending
                }
                ...
                <div className="flex flex-col items-center justify-center p-10 space-y-4 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1 max-w-[250px]">
                      Invite team members above to grant them access to this project.
                    </p>
                  </div>
                </div>
              ) : (
