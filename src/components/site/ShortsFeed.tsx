    ...
    <div className="flex justify-center w-full my-4">
      ...
      >
        {shorts.map((short) => (
          <div
            key={short.id}
            className="relative h-full w-full snap-start snap-always shrink-0 bg-black flex items-center justify-center overflow-hidden"
          >
            {/* Background / Media */}
            <img
              src={short.mediaUrl}
            ...
            <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10 pointer-events-none">
              <span className="text-white font-semibold text-sm drop-shadow-md tracking-wider">
                Shorts
              </span>
            ...
            <div className="absolute left-4 bottom-4 right-20 flex flex-col gap-3 z-10">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-white font-bold text-[15px] drop-shadow-md flex items-center gap-2">
                    {short.organizerName}
                    <button className="text-[11px] font-bold uppercase tracking-wider bg-white/20 hover:bg-white/30 backdrop-blur-sm px-2 py-0.5 rounded text-white transition">
                      Follow
                    </button>
                  </span>
                  <span className="text-white/90 text-xs drop-shadow-md mt-0.5">
                    Epic moments from the festival! 🎵✨ #live
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm px-3 py-1.5 rounded-full w-fit">
                ...
                <span className="text-white text-[11px] font-medium drop-shadow-md marquee">
                  Original Audio - {short.organizerName}
                </span>
              </div>
            </div>
          </div>
