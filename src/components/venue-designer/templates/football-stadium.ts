...
export const footballStadium: VenueTemplate = {
  ...
  sections: [
    // --- EAST STAND (Right) ---
    {
      id: "e1", name: "East Lower", color: "#22c55e", rows: 12, cols: 40, shape: "arc", x: 0, y: 0, rotation: 0, innerRadius: 180, outerRadius: 220, startAngle: 60, endAngle: 120,
      capacity: 0,
      type: "reserved",
      priceZone: "",
      visible: false
   ...
   , ...defaultProps },
    ...
    // --- WEST STAND (Left) ---
    {
      id: "w1", name: "West Lower", color: "#2563eb", rows: 12, cols: 40, shape: "arc", x: 0, y: 0, rotation: 0, innerRadius: 180, outerRadius: 220, startAngle: 240, endAngle: 300,
      capacity: 0,
      type: "reserved",
      priceZone: "",
      visible: false
   ...
   , ...defaultProps },
    ...
    // --- NORTH STAND (Top) ---
    {
      id: "n1", name: "North Lower", color: "#f59e0b", rows: 15, cols: 30, shape: "arc", x: 0, y: 0, rotation: 0, innerRadius: 140, outerRadius: 220, startAngle: -35, endAngle: 35,
      capacity: 0,
      type: "reserved",
      priceZone: "",
      visible: false
   ...
   , ...defaultProps },
    ...
    // --- SOUTH STAND (Bottom) ---
    {
      id: "s1", name: "South Lower", color: "#f59e0b", rows: 15, cols: 30, shape: "arc", x: 0, y: 0, rotation: 0, innerRadius: 140, outerRadius: 220, startAngle: 145, endAngle: 215,
      capacity: 0,
      type: "reserved",
      priceZone: "",
      visible: false
   ...
   , ...defaultProps },
    ...
    // --- CORNERS ---
    {
      id: "ne", name: "NE Corner", color: "#14b8a6", rows: 15, cols: 15, shape: "arc", x: 0, y: 0, rotation: 0, innerRadius: 180, outerRadius: 280, startAngle: 38, endAngle: 57,
      capacity: 0,
      type: "reserved",
      priceZone: "",
      visible: false
