    ...
    case "handball":
      return (
        <g transform="translate(-260, -170)">
          ...
          <path
            d="M16,70 Q190,70 190,170 Q190,270 16,270"
            fill="rgba(255,255,255,.07)"
            stroke="#fff"
            strokeWidth="2"
          />
          <path
            d="M16,30 Q240,30 240,170 Q240,310 16,310"
            fill="none"
            stroke="#fff"
            strokeWidth="1.5"
            strokeDasharray="8,5"
          ...
          <path
            d="M504,70 Q330,70 330,170 Q330,270 504,270"
            fill="rgba(255,255,255,.07)"
            stroke="#fff"
            strokeWidth="2"
          />
          <path
            d="M504,30 Q280,30 280,170 Q280,310 504,310"
            fill="none"
            stroke="#fff"
            strokeWidth="1.5"
            strokeDasharray="8,5"
    ...
    case "podium_classic":
      return (
        <g transform="translate(-60, -135)">
          ...
          <polygon
            points="30,90 90,90 82,194 38,194"
            fill="#2563eb"
            stroke="#1d4ed8"
            strokeWidth="2"
          />
    ...
    case "podium_glass":
      return (
        <g transform="translate(-147, -150)">
          ...
          <text x="147" y="112" fontFamily="Arial" fontSize="22" fill="#fff" textAnchor="middle">
            ★
          </text>
          <rect
            x="196"
    ...
    case "orchestra_pit":
      return (
        <g transform="translate(-200, -100)">
          <path
            d="M 0,0 L 400,0 A 200 200 0 0 1 0,0 Z"
            fill="#1f1f1f"
            stroke="#4b5563"
            strokeWidth="4"
          />
    ...
    case "ice_rink":
      return (
        <g transform="translate(-250, -125)">
          ...
          {/* Goal creases */}
          <path
            d="M 20,110 A 15 15 0 0 1 20,140 Z"
            fill="#bfdbfe"
            stroke="#ef4444"
            strokeWidth="2"
          />
          <path
            d="M 480,110 A 15 15 0 0 0 480,140 Z"
            fill="#bfdbfe"
            stroke="#ef4444"
            strokeWidth="2"
          />
