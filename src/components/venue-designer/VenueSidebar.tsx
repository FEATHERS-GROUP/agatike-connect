          ...
          <>
            ...
            <Panel title="Drawing Blocks" icon={Plus} defaultOpen={false}>
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={() =>
                    addSection(
                      ...
                      "general_admission",
                      undefined,
                      "M 0,-40 A 40 40 0 1 1 0,40 A 40 40 0 1 1 0,-40 Z",
                      undefined,
                      { name: "Circle Block" },
                    )
                  }
                ...
                >
                  ...
                  >
                    <polygon points="0,-40 40,40 -40,40" />
                  </svg>
                ...
                <button
                  onClick={() =>
                    addSection("rect", "general_admission", undefined, undefined, undefined, {
                      name: "Divider Line",
                      height: 8,
                      capacity: 0,
                      rows: 0,
            ...
            <Panel title="Angles & Notches" icon={LayoutGrid} defaultOpen={false}>
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={() =>
                    addSection("polygon", "reserved", "-63,-22 -63,22 3,-12 63,-12 63,-22")
                  }
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-secondary/20 p-3 text-center transition hover:border-primary/50 hover:bg-secondary/50"
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-63,-22 -63,22 3,-12 63,-12 63,-22" />
                  </svg>
                  <span className="text-xs font-medium">Notch Top-Left</span>
                </button>
                <button
                  onClick={() =>
                    addSection("polygon", "reserved", "-63,-22 63,-22 63,-12 3,22 -63,-12")
                  }
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-secondary/20 p-3 text-center transition hover:border-primary/50 hover:bg-secondary/50"
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-63,-22 63,-22 63,-12 3,22 -63,-12" />
                  </svg>
                  <span className="text-xs font-medium">Notch Btm-Left</span>
                </button>
                <button
                  onClick={() =>
                    addSection("polygon", "reserved", "-40,-50 -40,50 0,50 40,10 40,-50")
                  }
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-secondary/20 p-3 text-center transition hover:border-primary/50 hover:bg-secondary/50"
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-40,-50 -40,50 0,50 40,10 40,-50" />
                  </svg>
                  <span className="text-xs font-medium">Outer Top-Left</span>
                </button>
                <button
                  onClick={() =>
                    addSection("polygon", "reserved", "-50,-10 -10,-50 50,-50 50,50 -50,50")
                  }
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-secondary/20 p-3 text-center transition hover:border-primary/50 hover:bg-secondary/50"
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-50,-10 -10,-50 50,-50 50,50 -50,50" />
                  </svg>
            ...
            <Panel title="Wedges" icon={LayoutGrid} defaultOpen={false}>
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={() =>
                    addSection("polygon", "reserved", "-70,85 -70,-15 0,-85 70,-85 30,85")
                  }
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-secondary/20 p-3 text-center transition hover:border-primary/50 hover:bg-secondary/50"
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-70,85 -70,-15 0,-85 70,-85 30,85" />
                  </svg>
                ...
                <button
                  onClick={() =>
                    addSection("polygon", "reserved", "-70,-80 30,-80 70,80 0,80 -70,0")
                  }
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-secondary/20 p-3 text-center transition hover:border-primary/50 hover:bg-secondary/50"
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-70,-80 30,-80 70,80 0,80 -70,0" />
                  </svg>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-37,-19 37,-19 29,19 -29,19" />
                  </svg>
                ...
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-40,-20 40,-20 34,20 -34,20" />
                  </svg>
                ...
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-52,22 52,22 40,-22 -40,-22" />
                  </svg>
                ...
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <polygon points="-56,-22 56,-22 48,22 -48,22" />
                  </svg>
                ...
                <button
                  onClick={() =>
                    addSection(
                      ...
                      "reserved",
                      undefined,
                      "M -50,5 Q 0,-45 50,5 L 40,45 Q 0,0 -40,45 Z",
                    )
                  }
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-secondary/20 p-3 text-center transition hover:border-primary/50 hover:bg-secondary/50"
                >
                  <svg
                    ...
                    className="text-muted-foreground"
                  >
                    <path d="M -50,5 Q 0,-45 50,5 L 40,45 Q 0,0 -40,45 Z" />
                  </svg>
                ...
                >
                  <svg
                    width="24"
                    height="24"
                    viewBox="-30 -70 60 140"
                    fill="currentColor"
                    className="text-muted-foreground"
                  >
                    <polygon points="-25,66 -25,-54 25,-66 25,54" />
                  </svg>
