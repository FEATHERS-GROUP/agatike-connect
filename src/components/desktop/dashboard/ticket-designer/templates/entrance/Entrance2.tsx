        ...
        {isBack ? (
          <div className="relative flex-1 p-6 flex flex-row bg-black/40 backdrop-blur-md">
             ...
             <div className="w-[180px] pl-6 flex flex-col items-center justify-center">
                ...
                <div className="p-2 border border-white/20 rounded-xl bg-white/10 shadow-sm backdrop-blur-lg mb-2">
                   <QRCode value={qrValue || orderId} size={90} fgColor="#ffffff" bgColor="transparent" />
                </div>
          ...
          <>
            ...
            <div className="relative flex-1 flex flex-col p-6">
              ...
              {/* Title Card */}
              <div className="flex-1 flex flex-col justify-center" style={{ textAlign: layout.titleAlign as any, marginTop: `${layout.titleOffsetY}%` }}>
                 <h2 className="font-black leading-tight tracking-tight drop-shadow-sm" style={{ fontSize: `${layout.titleSize + 4}px` }}>
                    {title}
                 </h2>
                 <p className="mt-1 font-medium text-white/80 uppercase tracking-widest text-xs" style={{ fontSize: `${layout.subtitleSize}px` }}>
                    {subtitle}
                 </p>
              </div>

              {/* Meta Information Cards */}
              <div className="grid grid-cols-4 gap-3 mt-4" style={{ fontSize: `${layout.metaSize}px` }}>
                 ...
                 <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-3 shadow-sm flex flex-col justify-center">
                    <p className="text-[8px] uppercase tracking-widest text-white/60 mb-0.5">Entry / Area</p>
                 ...
                 <div className="bg-white/20 backdrop-blur-xl border border-white/30 rounded-xl p-3 shadow-sm flex flex-col justify-center">
                    ...
                    <p className="font-black text-sm truncate">{currency}{price}</p>
                 </div>
              </div>
            </div>
            ...
            <div className="w-[180px] p-5 flex flex-col items-center justify-center border-l border-white/10 bg-white/5 backdrop-blur-md">
               ...
               <p className="text-[8px] uppercase tracking-widest text-white/60 font-bold text-center">Scan at entry</p>
