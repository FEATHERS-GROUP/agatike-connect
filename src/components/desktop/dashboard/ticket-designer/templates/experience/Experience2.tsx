          ...
          <div className="relative flex-1 p-6 flex flex-row w-full h-full">
            <div className="flex-1 flex flex-col justify-between pr-6 border-r border-[#334155]">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-black tracking-[0.3em] uppercase text-[#38bdf8]">
                  {logoText}
                </span>
              </div>
              <div
                className="ticket-back-content text-[11px] leading-relaxed py-4 text-[#94a3b8]"
            ...
            <div className="w-[200px] pl-6 flex flex-col items-center justify-center text-center">
              {back.backImage && (
                <img
                  ...
                  src={back.backImage}
                  className="w-full h-[120px] object-cover rounded-xl mb-4 border border-[#334155]"
          ...
          <>
            ...
            <div className="relative z-10 flex-1 p-6 flex flex-col justify-between overflow-hidden">
              ...
              <div
                ...
                style={{
                  backgroundImage: `radial-gradient(${palette.from} 1px, transparent 1px)`,
              ...
              ></div>
              <div
                className="absolute -left-20 -bottom-20 w-64 h-64 rounded-full opacity-20 blur-3xl pointer-events-none"
              ...
              <div className="flex justify-between items-center relative z-10">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm font-black tracking-[0.25em] uppercase opacity-90">
                    {logoText}
                  </span>
                </div>
                <div className="flex items-center gap-2 px-3 py-1 rounded border border-[#334155] bg-[#1e293b]">
                  <span
                    ...
                    style={{ background: palette.from }}
                  ></span>
                  <span className="text-[10px] font-mono tracking-widest text-[#94a3b8]">
                    BOARDING PASS
                  </span>
                </div>
              </div>
              ...
              >
                <div className="flex-1">
                  ...
                  <h2
                    className="font-black leading-none uppercase tracking-tight text-white drop-shadow-md"
                    style={{ fontSize: `${layout.titleSize + 2}px` }}
                  >
                    {title}
                  </h2>
                  <p
                    className="mt-2 text-[#94a3b8] font-medium whitespace-pre-line"
              ...
              {/* Meta Info Grid */}
              <div
                className="relative z-10 grid grid-cols-4 gap-4 mt-6 bg-[#1e293b] rounded-xl p-4 border border-[#334155]"
              ...
              >
                ...
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-[#64748b]">{seatLabel ? `${seatLabel} / Spot` : "Seat / Spot"}</p>
            ...
            <div className="relative w-[200px] flex flex-col justify-between p-6 bg-[#0f172a] overflow-hidden z-10">
              <div
                className="absolute right-0 top-0 bottom-0 w-1 shadow-[inset_-20px_0_30px_rgba(0,0,0,0.5)] pointer-events-none"
                style={{ background: palette.from }}
              ></div>

              <div className="w-full text-right">
                <p className="text-[9px] uppercase tracking-[0.2em] text-[#64748b] mb-1">
                  Amount Paid
                </p>
