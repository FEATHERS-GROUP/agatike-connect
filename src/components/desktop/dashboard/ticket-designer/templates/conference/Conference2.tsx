      ...
      >
        {isBack ? (
          <div className="relative flex-1 flex flex-row p-6 bg-gray-50">
            <div
              className="flex-1 overflow-hidden ticket-back-content text-[11px] text-gray-600 leading-relaxed pr-6 border-r border-gray-200"
            ...
            <div className="relative flex-1 flex flex-col p-8">
              ...
              <div className="relative z-10 flex justify-between items-start mb-6">
                {logoImage ? (
                  ...
                  <span className="text-xl font-black tracking-[0.2em] uppercase text-gray-900">
                    {logoText}
                  </span>
                )}
                <span
                  className="text-white px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-md"
              ...
              >
                ...
                <p
                  className="mt-1 font-semibold text-gray-500 uppercase tracking-widest"
              ...
              <div
                className="relative z-10 grid grid-cols-3 gap-6 mt-6 border-t border-gray-100 pt-4"
