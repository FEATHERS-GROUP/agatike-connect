...
export function PreviewComponent({
  ...
  if (comp.type === "button") {
    return (
      <div className="flex justify-center w-full px-4 py-4">
        {wrap(
          "button",
          <div className="w-full h-full flex items-center justify-center text-sm font-bold shadow-md text-white text-center cursor-pointer">
              ...
              {wrap(
                ...
                >
                  ...
                  {card.bulletPoints ? (
                    wrap(
                      "card_item_desc",
                      <div className="prose prose-xs dark:prose-invert mb-6 flex-1 whitespace-pre-wrap w-full">
                        {card.bulletPoints}
                      </div>,
                      "100%",
                      "auto",
                    ...
                    wrap(
                      "card_item_desc",
                      <p className="line-clamp-3 mb-6 flex-1 text-sm w-full">
                        {linkedForm.description}
                      </p>,
                      "100%",
                      "auto",
                  ...
                  {wrap(
                    "card_item_button",
                    <div className="w-full rounded-full py-2 text-center text-white text-sm font-medium mt-auto flex items-center justify-center">
  ...
  const isPaymentForm =
    comp.type === "payment_button" && comp.connectedFormId && comp.connectedFormId !== "none";
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left w-full">
          ...
          {displayDesc &&
            wrap(
              "form_desc",
              <p className="text-muted-foreground text-sm line-clamp-2 mb-3">{displayDesc}</p>,
              "100%",
              "auto",
              "0px",
              "0px",
  ...
  if (
    ...
    return (
      <div className="flex flex-col items-center justify-center w-full px-4 py-6">
        {wrap(
          "pay_button",
          <div className="rounded-full px-8 py-4 text-sm font-bold shadow-md text-white flex flex-col items-center justify-center gap-1 h-full w-full">
  ...
  if (
    ...
    comp.type === "damage_report" ||
    comp.type === "ticket_type_list"
  ) {
    return (
                  ...
                  <div className="p-4 flex-1 flex flex-col w-full">
                    ...
                    {wrap(
                      ...
                      <p className="text-xs text-muted-foreground mb-4 line-clamp-2">
                        This is a placeholder for your workspace{" "}
                        {typeLabels[comp.type].toLowerCase()}. It will be populated with real data
                        on the live page.
                      </p>,
                      "100%",
                      "auto",
                    ...
                    <div className="mt-auto flex items-center justify-between pt-2 w-full">
                      ...
                      {comp.allowSelling !== false &&
                        wrap(
                          "inv_item_button",
                          <div className="px-3 py-1.5 text-xs font-bold text-white flex items-center justify-center">
