    ...
    <div className="w-full max-w-6xl mx-auto flex-1 min-w-0 mb-24 transition-all duration-300 group/canvas">
      <div className="bg-background border border-border/40 rounded-2xl overflow-hidden shadow-2xl shadow-black/10 ring-1 ring-black/5 flex flex-col">
        ...
        >
          ...
          {editorState.navbarStyle === "transparent" &&
            editorState.logoUrl &&
            editorState.logoPosition === "navbar" && (
              <div className="absolute top-0 left-0 w-full p-8 flex items-start z-10 pointer-events-none">
                <img
                  src={editorState.logoUrl}
                  alt="Logo"
                  className="h-10 max-w-[150px] object-contain drop-shadow-md"
                />
              </div>
            )}
          ...
          <div
            className={`relative z-10 w-full max-w-5xl mx-auto flex items-center gap-8 ${
              editorState.heroForegroundImageUrl && editorState.heroForegroundPosition === "left"
                ? "flex-row-reverse"
                : ""
            }`}
          >
            ...
            >
              ...
              {editorState.logoUrl && editorState.logoPosition === "hero" && (
                <img
                  src={editorState.logoUrl}
                  alt="Logo"
                  className="h-16 max-w-[200px] object-contain mb-4 drop-shadow-md"
                />
              )}
              <Input
              ...
              >
                ...
                {editorState.heroButtonActionType === "page" ? (
                  ...
                  <Input
                    ...
                    onChange={(e) => set("heroButtonLink")(e.target.value)}
                    placeholder={
                      editorState.heroButtonActionType === "phone" ? "+1234567890" : "https://..."
                    }
        ...
        <div className="p-5 space-y-4">
          {editorState.components.length === 0 && (
            <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground border-2 border-dashed border-border/50 rounded-xl">
              ...
              <p className="text-sm">Add blocks from the panel on the right to build your page.</p>
            </div>
          )}
