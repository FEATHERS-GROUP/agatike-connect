...
export function EditorFloatingToolbar({ zoomLevel, setZoomLevel }: any) {
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-1.5 p-1.5 bg-card border border-border/60 shadow-lg rounded-full z-20">
      ...
      <Button className="h-8 px-4 rounded-full bg-primary/10 text-primary hover:bg-primary/20 text-xs font-medium ml-1">
        Upgrade Plan
      </Button>
    </div>
  );
