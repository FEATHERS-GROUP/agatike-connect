export const MOCK_MOVIES = [
  ...
  },
  {
    ...
    rating: "PG-13",
    cover:
      "https://m.media-amazon.com/images/M/MV5BZmIwMmU4ZWQtOTczZi00ZWEwLThhNjgtZTkwZDRlYmYzNDhkXkEyXkFqcGc@._V1_.jpg",
  ...
  },
  {
    ...
    rating: "PG",
    cover:
      "https://m.media-amazon.com/images/M/MV5BNzY0ZTlhYzgtOTgzZC00ZTg2LTk4NTEtZDllM2E2NGE5Njg2XkEyXkFqcGc@._V1_.jpg",
    cinema: "Century Cinemax",
    price: 3000,
    currency: "RWF",
  },
  ...
  },
  {
    ...
    duration: "2h 28m",
    rating: "R",
    cover: "https://images.unsplash.com/photo-1618331835717-801e976710b2?w=800&fit=crop",
    cinema: "Ster-Kinekor",
    price: 3000,
    currency: "RWF",
  },
  ...
  },
  {
    ...
    rating: "PG",
    cover:
      "https://m.media-amazon.com/images/M/MV5BMjJkZjE4NjMtNWVjMC00YzIzLWIwYmUtNTBmY2Q0OTQxYTVjXkEyXkFqcGc@._V1_.jpg",
    cinema: "Ster-Kinekor",
    price: 3000,
    currency: "RWF",
  },
  ...
  },
  {
    ...
    rating: "PG",
    cover:
      "https://m.media-amazon.com/images/M/MV5BYjkwOWViYzYtMDQzNi00N2U0LWIxYTktNWE2ZDYyM2FhN2M5XkEyXkFqcGc@._V1_.jpg",
    cinema: "Ster-Kinekor",
    price: 3000,
    currency: "RWF",
  },
  ...
  },
  {
    ...
    rating: "PG",
    cover:
      "https://m.media-amazon.com/images/M/MV5BMzJlNGYxYzQtOTg4MC00OTMyLTkwYzMtZDRlNTgwY2YwOWYxXkEyXkFqcGc@._V1_.jpg",
    cinema: "Canal Olympia",
    price: 3000,
    currency: "RWF",
  },
...
export const MOCK_MOVIES_MAP: Record<string, any> = MOCK_MOVIES.reduce(
  (acc, movie) => {
    acc[movie.id] = movie;
    return acc;
  },
