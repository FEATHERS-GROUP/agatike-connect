...
export const PAGE_TEMPLATES: PageTemplate[] = [
  ...
  },
  {
    ...
    name: "Sell Products",
    category: "Sales",
    description: "Sell your products and add-ons directly through your page.",
    themeColor: "#5b21b6",
    fontFamily: "Inter",
    logoPosition: "hero",
    title: "Our Products",
    pageDescription: "Browse our catalog and purchase products directly.",
    headerImageUrl: "",
    components: [
      {
        id: "1",
      ...
      },
      {
        id: "2",
        type: "payment_button",
        label: "Buy Premium Package",
        amount: "50000",
        description: "Purchase our premium package and get exclusive access.",
        paymentLink: "",
      },
    ],
  },
  {
    ...
    name: "Product Orders",
    category: "Sales",
    description: "A template to showcase your product catalog and take orders.",
    themeColor: "#1d4ed8",
    fontFamily: "Outfit",
    logoPosition: "navbar",
    title: "Product Orders",
    pageDescription: "Order the products you need.",
    headerImageUrl: "",
    components: [
      {
        id: "1",
