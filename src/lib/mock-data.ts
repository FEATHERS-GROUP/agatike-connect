...
export const events: Event[] = [
  ...
  // Kenya
  {
    id: "nairobi-jazz-fest",
    title: "Nairobi Jazz & Soul Festival",
    organizer: "East Africa Music Co.",
    organizerHandle: "eamusicco",
    city: "Nairobi, KE",
    venue: "Uhuru Gardens",
    ...
    attendees: 8500,
    rating: 4.8,
    description: "Two days of jazz, soul and R&B with top East African and international artists at Nairobi's iconic Uhuru Gardens.",
    lat: -1.302,
    lng: 36.818,
    hasStory: true,
  },
  {
    id: "nairobi-marathon",
    title: "Nairobi Standard Chartered Marathon",
    organizer: "Athletics Kenya",
    organizerHandle: "athleticskenya",
    city: "Nairobi, KE",
    venue: "Uhuru Park Start Line",
    date: "Sun, Oct 25, 2026",
    time: "07:00",
    category: "Sports",
    currency: "KES",
    price: 1000,
    cover: "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?auto=format&fit=crop&w=800&q=80",
    attendees: 22000,
    rating: 4.9,
    description: "One of Africa's oldest and most iconic marathons. Run through the heart of Nairobi with 22,000 participants.",
    lat: -1.290,
    lng: 36.824,
    hasStory: false,
  },
  // Morocco
  {
    id: "gnawa-festival-essaouira",
    title: "Gnawa World Music Festival",
    organizer: "Essaouira Mogador",
    organizerHandle: "essaouirafest",
    city: "Essaouira, MA",
    ...
    currency: "MAD",
    price: 0,
    cover: "https://images.unsplash.com/photo-1533174000220-400f40d58849?auto=format&fit=crop&w=800&q=80",
    attendees: 45000,
    rating: 5.0,
    description: "The world-renowned annual festival celebrating Gnawa music and its fusion with jazz, blues and world music. Free entry.",
    lat: 31.513,
    lng: -9.771,
    hasStory: true,
  },
  {
    id: "casablanca-business-summit",
    title: "Africa Business Summit — Casablanca",
    organizer: "OCP Group",
    organizerHandle: "ocpgroup",
    city: "Casablanca, MA",
    venue: "Anfa Place",
    date: "Tue, Dec 15, 2026",
    time: "09:00",
    category: "Conferences",
    currency: "MAD",
    price: 1200,
    cover: "https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=800&q=80",
    attendees: 5000,
    rating: 4.7,
    description: "Africa's premier annual business summit bringing together leaders in finance, tech, and trade from across the continent.",
    lat: 33.588,
    lng: -7.623,
    hasStory: true,
  },
  // Madagascar
  {
    id: "madagascar-wildlife-tour",
    title: "Lemur Trekking Experience",
    organizer: "Madagascar Nature Tours",
    organizerHandle: "madnature",
    city: "Antananarivo, MG",
    venue: "Andasibe National Park",
    date: "Sat, May 09, 2026",
    time: "06:30",
    category: "Trips",
    currency: "MGA",
    price: 85000,
    cover: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Indri_indri_02.jpg",
    attendees: 80,
    rating: 4.9,
    description: "A guided sunrise trek through Madagascar's lush rainforest in search of Indri lemurs and rare flora.",
    lat: -18.921,
    lng: 47.522,
    hasStory: false,
  },
  ...
  {
    id: "cape-town-jazz-fest",
    title: "Cape Town International Jazz Festival",
    organizer: "EspAfrika",
    organizerHandle: "espafrikajazz",
    city: "Cape Town, ZA",
    venue: "CTICC",
    ...
    currency: "ZAR",
    price: 850,
    cover: "https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?auto=format&fit=crop&w=800&q=80",
    attendees: 38000,
    rating: 4.9,
    description: "Affectionately known as 'Africa's Grandest Gathering', this festival is the largest jazz festival on the continent.",
    lat: -33.915,
    lng: 18.426,
    hasStory: true,
  },
  {
    id: "springboks-rugby-match",
    title: "Springboks vs All Blacks",
    organizer: "SA Rugby",
    organizerHandle: "springboks",
    city: "Johannesburg, ZA",
    ...
    currency: "ZAR",
    price: 1500,
    cover: "https://images.unsplash.com/photo-1560272564-c83b66b1ad12?auto=format&fit=crop&w=800&q=80",
    attendees: 62000,
    rating: 5.0,
    description: "The ultimate rugby rivalry. Watch the world champion Springboks take on the mighty All Blacks in Johannesburg.",
    lat: -26.197,
    lng: 28.061,
    hasStory: false,
  },
  // Ethiopia (Conferences)
  {
    id: "au-summit-addis",
    title: "African Union Annual Summit",
    organizer: "African Union",
    organizerHandle: "africanunion",
    city: "Addis Ababa, ET",
    venue: "AU Headquarters",
    date: "Mon, Feb 02, 2026",
    time: "08:30",
    category: "Conferences",
    currency: "ETB",
    price: 0,
    cover: "https://upload.wikimedia.org/wikipedia/commons/e/ec/African_Union_headquarters.jpg",
    attendees: 5000,
    rating: 4.8,
    description: "The annual assembly of Heads of State and Government of the African Union to discuss continental policies and integration.",
    lat: 8.995,
    lng: 38.746,
    hasStory: true,
  },
  {
    id: "addis-tech-expo",
    title: "Addis Tech & Innovation Expo",
    organizer: "MinT Ethiopia",
    organizerHandle: "mintech_et",
    city: "Addis Ababa, ET",
    venue: "Millennium Hall",
    date: "Wed, Dec 09, 2026",
    time: "09:00",
    category: "Conferences",
    currency: "ETB",
    price: 500,
    ...
    attendees: 12000,
    rating: 4.6,
    description: "Ethiopia's largest technology exhibition showcasing startups, enterprise solutions, and digital transformation initiatives.",
    lat: 8.989,
    lng: 38.788,
    hasStory: true,
  },
