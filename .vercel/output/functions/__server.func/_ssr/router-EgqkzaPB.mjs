...
import { b as createRouter, a as createRootRouteWithContext, e as useRouter, L as Link, f as useRouterState, O as Outlet, H as HeadContent, S as Scripts, c as createFileRoute, l as lazyRouteComponent, u as useLocation } from "../_libs/tanstack__react-router.mjs";
import { G as notFound } from "../_libs/tanstack__router-core.mjs";
import { j as jsxRuntimeExports, r as reactExports } from "../_libs/react.mjs";
import { c as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { w as House, p as Compass, G as Map, A as Activity, ab as User } from "../_libs/lucide-react.mjs";
...
function MobileNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 z-50 px-4 pb-safe pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto flex h-16 max-w-md items-center justify-between rounded-full border border-border/40 bg-background/80 px-6 shadow-lg backdrop-blur-xl mb-4", children: tabs.map((tab) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: cn("h-6 w-6", isActive && "fill-primary/20 stroke-[2.5]") }),
          isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-2 h-1 w-1 rounded-full bg-primary" })
        ]
      },
      tab.name
    );
...
function AppProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppContext.Provider, { value: { isOrganizerMode, setOrganizerMode, toggleOrganizerMode }, children });
}
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `min-h-screen md:pb-0 ${hideNav ? "" : "pb-24"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    !hideNav && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MobileNav, {}) })
  ] }) });
}
...
const events = [
  {
    ...
    attendees: 1284,
    rating: 4.9,
    description: "An electric night of Afrobeats with top DJs from across the continent. Rooftop bars, surprise live sets, and the best crowd in the city.",
    lat: -1.9441,
    lng: 30.0619,
    hasStory: true
  },
  {
    ...
    attendees: 540,
    rating: 4.8,
    description: "Golden hour cocktails, live house, and panoramic views over Nairobi. Limited tickets.",
    lat: -1.95,
    lng: 30.058,
    hasStory: false
  },
...
const feedPosts = events.map((ev, i) => ({
  ...
  caption: i % 2 === 0 ? `Last night was unreal at ${ev.title} — tag yourself in the moments below.` : `Tickets dropping for ${ev.title}. Don't sleep on this one.`,
  likes: 1200 + i * 317,
  comments: 48 + i * 11,
  eventId: ev.id,
  eventTitle: ev.title,
...
const Route$5 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Discover music, nightlife, sports, festivals and experiences across Africa. Buy tickets, share moments, follow organizers."
    }, {
      property: "og:title",
...
const Route$2 = createFileRoute("/events/$eventId")({
  loader: ({
    ...
    const ev = events.find((e) => e.id === params.eventId) || experiences.find((x) => x.id === params.eventId) || movies.find((m) => m.id === params.eventId);
