import { q as e } from "./index-BbCjida8.js";
function a() {
  return e.jsxs("footer", {
    className: "mt-24 border-t border-border/60 bg-secondary/40",
    children: [
      e.jsxs("div", {
        className: "mx-auto max-w-7xl px-6 py-14 grid gap-10 md:grid-cols-5",
        children: [
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("a", {
                    className:
                      "rounded-full border border-border bg-background px-4 py-2 hover:bg-secondary transition",
                    href: "#",
                    children: "App Store",
                  }),
                  e.jsx("a", {
          ...
          [
            ...
            e.jsxs(
              ...
              {
                children: [
                  e.jsx("p", { className: "text-sm font-semibold", children: r.title }),
                  e.jsx("ul", {
                    className: "mt-4 space-y-2 text-sm text-muted-foreground",
                    children: r.links.map((s) =>
                      e.jsx(
                        "li",
                        {
                          children: e.jsx("a", {
      ...
      e.jsxs("div", {
        ...
        children: ["© ", new Date().getFullYear(), " Agatike. Made with rhythm across Africa."],
      }),
    ],
  });
}
