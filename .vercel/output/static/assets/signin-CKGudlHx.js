import { l, w as s, q as e, L as d } from "./index-BbCjida8.js";
import { N as f } from "./Navbar-8zxmLK7V.js";
import { B as n } from "./button-BtHMdeJ3.js";
import { I as i } from "./input-Bn2qJlr0.js";
import { L as o } from "./label-MewfGgAd.js";
import { h as j } from "./hero-event-Cqx_3vn6.js";
import { L as N } from "./lock-BepScWQs.js";
import { E as b } from "./eye-BR3N6Y_-.js";
...
const A = [
  ...
  S = l("mail", A);
function B() {
  const [t, m] = s.useState("signin"),
    [a, x] = s.useState(!1),
    [u, h] = s.useState(""),
    [p, c] = s.useState(!1),
    g = (r) => {
      (r.preventDefault(), c(!0), setTimeout(() => c(!1), 2500));
    };
  return e.jsxs("div", {
      ...
      e.jsxs("div", {
        ...
        children: [
          e.jsxs("div", {
            ...
            children: [
              e.jsx("img", { src: j, alt: "", className: "h-[640px] w-full object-cover" }),
              e.jsx("div", {
                className:
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  ...
                  e.jsx("h1", {
                    ...
                    children: t === "signin" ? "Welcome back" : "Create your account",
                  }),
                  e.jsx("p", {
                  ...
                  e.jsxs("div", {
                    ...
                    children: [
                      ...
                      e.jsxs(n, {
                        ...
                        type: "button",
                        className: "rounded-xl",
                        children: [e.jsx(y, { className: "mr-2 h-4 w-4" }), " Apple"],
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("span", { className: "h-px flex-1 bg-border" }),
                      " or with email",
                      " ",
                      e.jsx("span", { className: "h-px flex-1 bg-border" }),
                    ],
                  ...
                  e.jsxs("form", {
                    ...
                    children: [
                      t === "signup" &&
                        e.jsxs("div", {
                          children: [
                            e.jsx(o, { htmlFor: "name", children: "Full name" }),
                            e.jsx(i, {
                              id: "name",
                              required: !0,
                      ...
                      e.jsxs("div", {
                        children: [
                          e.jsx(o, { htmlFor: "email", children: "Email" }),
                          e.jsxs("div", {
                      ...
                      e.jsxs("div", {
                        children: [
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx(o, { htmlFor: "pw", children: "Password" }),
                              t === "signin" &&
                                e.jsx("button", {
                                  type: "button",
                  ...
                  e.jsxs("p", {
                    ...
                    children: [
                      t === "signin" ? "New to Agatike?" : "Already have an account?",
                      " ",
                      e.jsx("button", {
                        onClick: () => m(t === "signin" ? "signup" : "signin"),
                        className: "font-medium text-primary hover:underline",
                        children: t === "signin" ? "Create an account" : "Sign in",
                      }),
                    ],
                  }),
                ],
              ...
              e.jsxs("p", {
                ...
                children: [
                  ...
                  " ",
                  e.jsx(d, { to: "/", className: "underline", children: "Terms" }),
                  " ",
                  "and",
                  " ",
                  e.jsx(d, { to: "/", className: "underline", children: "Privacy" }),
                  ".",
                ],
              }),
            ],
