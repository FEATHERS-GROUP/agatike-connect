      ...
      args: [
        {
          ...
          args: { table: "events", relationship: "agatike_book_records" },
        },
        {
          type: "pg_untrack_table",
          args: { table: { schema: "public", name: "agatike_book_records" }, cascade: true },
        },
      ],
    }),
  });
      ...
      args: [
        ...
        { type: "pg_track_table", args: { schema: "public", name: "agatike_book_records" } },
        {
          ...
          args: {
            table: "events",
            name: "agatike_books",
            using: { foreign_key_constraint_on: { table: "agatike_books", column: "event_id" } },
          },
        },
        {
          type: "pg_create_array_relationship",
          args: {
            ...
            name: "records",
            using: {
              foreign_key_constraint_on: { table: "agatike_book_records", column: "book_id" },
            },
          },
        },
        {
          ...
          args: {
            table: "agatike_book_records",
            name: "book",
            using: { foreign_key_constraint_on: "book_id" },
          },
        },
      ],
    }),
