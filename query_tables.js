  ...
  const tables = data.data.__schema.types
    ...
    .filter(
      (name) =>
        ...
        !name.includes("_mutation") &&
        !name.includes("_bool_exp") &&
        !name.includes("_min") &&
        !name.includes("_max") &&
        !name.includes("_stddev") &&
        !name.includes("_var") &&
        !name.includes("_avg") &&
        !name.includes("_sum") &&
        !name.includes("_inc") &&
        !name.includes("_set") &&
        !name.includes("_append") &&
        !name.includes("_prepend") &&
        !name.includes("_delete") &&
        !name.includes("_insert") &&
        !name.includes("_update") &&
        !name.includes("_select") &&
        !name.includes("_stream") &&
        !name.includes("_constraint") &&
        !name.includes("_on_conflict") &&
        !name.includes("_order_by") &&
        !name.includes("_pk_columns_input") &&
        !name.includes("_comparison_exp"),
    );
