...
const file = "src/routes/dashboard/$workspaceSlug/ticket-designer/index.tsx";
...
code = code.replace("  const createMutation = useMutation({", "  const queryClient = useQueryClient();\n" + mutationsStr + "\n  const createMutation = useMutation({");
...
const wrapperStart = `
          ...
          >
            {({ filteredItems, folders, handleSelect, selectedIds }) => (
...
console.log("Updated ticket designer page");
