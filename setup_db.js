    ...
    body: JSON.stringify({
      ...
      args: {
        ...
        sql: `
          ...
          ALTER TABLE public.space_subscriptions ADD COLUMN IF NOT EXISTS customer_address text;
          ...
          ALTER TABLE public.space_subscriptions ADD COLUMN IF NOT EXISTS membership_id text UNIQUE;
        `,
      },
    }),
  });
