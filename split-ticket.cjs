...
fs.writeFileSync(
  "src/components/ticket-viewer/DynamicPass.tsx",
  dynamicPassImports + "export " + dynamicPassCode,
);
...
fs.writeFileSync(
  "src/components/ticket-viewer/CarouselStack.tsx",
  carouselStackImports + "export " + carouselStackCode,
);

// Remove extracted code from original file
fs.writeFileSync("src/routes/ticket/$ticketId.tsx", ticketViewerCode);
